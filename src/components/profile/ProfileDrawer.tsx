...
import { GOAL_TONE_BY_OBJECTIVE, PROFILE_MAX_COUNT } from '../../lib/profiles/constants';
            ...
            <div className={settingsProfile ? 'df-profile-drawer-track is-settings' : 'df-profile-drawer-track'}>
              <section className="df-profile-drawer-page">
                ...
                <div className="df-profile-cards">
                  ...
                  {profiles.length === 0 ? (
                    <div className="df-profile-empty">Nenhum perfil salvo ainda. Crie seu primeiro perfil ao finalizar o formulário.</div>
                  ) : null}
                </div>
              </section>
